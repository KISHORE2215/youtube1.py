...
api_key = "AIzaSyCKkOar8djrNMCgmlthQoeaVcJ3z_EB7mI"
...
# Function to insert videos into the database
...
def main():
    ...
    selected_option = st.sidebar.selectbox("", ["Home Page", "Extract and Transform", "MYSQL Database View"])
    ...
    if selected_option == "Home Page":
    ...
    elif selected_option == "MYSQL Database View":
        def view_data(query):
            st.title("View Data")
            try:
                mycursor.execute(query)
        ...
        questions = st.selectbox('Questions', [
                        ...
                        # Handle  10 different question selections
